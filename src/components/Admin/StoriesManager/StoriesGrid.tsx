...
function SortableStoryItem({ story, activeTab, onEdit, onArchive, onRestore }: {
  story: Story;
  activeTab: 'active' | 'scheduled' | 'archived';
  onEdit: (story: Story) => void;
  onArchive: (id: string) => void;
  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <button
          className="absolute top-2 left-2 p-2 bg-gradient-to-r from-[#6B0F6C] to-[#FF0A7B] rounded-full text-white shadow-lg hover:shadow-xl transition-all duration-300 cursor-grab active:cursor-grabbing"
          {...attributes}
          {...listeners}
        >
