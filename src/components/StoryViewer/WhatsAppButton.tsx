...
export function WhatsAppButton({ phoneNumber, message }: WhatsAppButtonProps) {
  ...
  return (
    <button
      onClick={handleClick}
      className="group flex items-center gap-2 px-4 py-2 bg-[#25D366] hover:bg-[#1fb959] text-white rounded-full transition-all duration-300 font-medium shadow-lg hover:shadow-xl"
    >
      <svg 
        viewBox="0 0 24 24" 
